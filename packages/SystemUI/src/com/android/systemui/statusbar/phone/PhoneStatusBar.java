...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
	...
	addAppCircleSidebar();
        ...
        mTipsyLabel = (TextView)mStatusBarView.findViewById(R.id.tipsy_custom_label);
        ...
        if ((diff & StatusBarManager.DISABLE_NOTIFICATION_ICONS) != 0) {
            if ((state & StatusBarManager.DISABLE_NOTIFICATION_ICONS) != 0) {
                ...
                if (mGreeting != null && !TextUtils.isEmpty(mGreeting) && mShowLabel) {
                    if (animate) {
                        mTipsyLabel.setVisibility(View.VISIBLE);
                        mTipsyLabel.animate().cancel();
                        mTipsyLabel.animate()
                                .alpha(1f)
                                .setDuration(400)
    ...
    protected void labelAnimatorFadeOut(final boolean animate) {
        ...
        mTipsyLabel.animate()
            ...
            @Override
            public void run() {
                mTipsyLabel.setVisibility(View.GONE);
                animateStatusBarShow(mNotificationIconArea, animate);
            }
        });
    }
